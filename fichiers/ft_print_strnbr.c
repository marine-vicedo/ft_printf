...
/*   Updated: 2022/06/15 12:39:00 by mvicedo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*unsigned int	ft_putnbr(int nb)
{
	...
	str = ft_itoa(nb); //retourne une str issue de la conversion de nb par itoa
	nb_len = ft_putstr(str); //print et calcule la lenght de str
	free (str); // on libere car itoa malloc
	return (nb_len);
}
...
unsigned int ft_unsigned_putnbr(unsigned int nb)
{
	...
	str = ft_unsigned_itoa(nb); //retourne une str issue de la conversion de nb par itoa
	nb_len = ft_putstr(str); //print et calcule la lenght de str
	free (str); // on libere car itoa malloc
	return (nb_len);
}*/
